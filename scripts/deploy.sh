...
echo -e "${BLUE}╔════════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║  orders-microservice - Kubernetes Deployment${NC}"
echo -e "${BLUE}╚════════════════════════════════════════════════════════╝${NC}"
...
kubectl exec -n "$NAMESPACE" "$POD" -- wget -qO- "http://localhost:3203/health" || exit 1
deploy_timing_phase_end "Health check"

deploy_timing_finish_success "orders-microservice"
