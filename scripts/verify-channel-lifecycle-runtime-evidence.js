...
const CHANNELS = {
  ...
  heureka: {
    ...
    artifactChecks: [
      ...
      {
        root: 'orders',
        file: 'reports/validation/orders-browser-render-proof/heureka-dashboard-dom-runtime-blocked-artifact.json',
        type: 'json',
        assertions: [
          ['schemaVersion', 'orders.browser_render_artifact.v1'],
          ['channel', 'heureka'],
          ...
          ['hasOrdersTableBody', true],
          ['ordersSectionHidden', true],
          ['blocker', '[MISSING: Heureka dashboard orders DOM rows did not render]'],
          ['pageErrors.0.textSample', 'Invalid regular expression flags'],
          ['redacted', true],
          ['tokenValuesPrinted', false],
          ['rawOrderRowsPrinted', false],
    ...
    remainingGates: [
      'Heureka dashboard orders-list central lifecycle API proof is proven; visible DOM proof is blocked by a deployed dashboard JavaScript runtime error (`Invalid regular expression flags`) before orders rows render',
...
const result = {
  ...
  remainingIntegrationGates: [
    ...
    'Heureka browser DOM render capture was attempted with service-scoped auth and is blocked by a deployed dashboard JavaScript runtime error before orders rows render',
