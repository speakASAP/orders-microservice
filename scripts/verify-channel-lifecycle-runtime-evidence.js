...
const CHANNELS = {
  ...
  aukro: {
    ...
    artifactChecks: [
      ...
      {
        root: 'orders',
        file: 'reports/validation/orders-browser-render-proof/aukro-dashboard-admin-dom-proven-customer-empty-artifact.json',
        type: 'json',
        assertions: [
          ['schemaVersion', 'orders.browser_render_artifact.v1'],
          ['channel', 'aukro'],
          ...
          ['proofMode', 'service_scoped_proxy'],
          ['status', 'admin_dom_lifecycle_proven_customer_rows_empty'],
          ['documentStatus', 200],
          ...
          ['protectedCallStatuses.0.ordersCount', 0],
          ['protectedCallStatuses.0.centralLifecycleCount', 0],
    ...
    remainingGates: [
      'Aukro admin visible DOM lifecycle proof is service-scoped and proven; customer visible DOM rows remain gated by a real or bounded customer-bound Aukro order because current proof subject has ordersCount=0',
    ],
  },
};
...
const result = {
  ...
  remainingIntegrationGates: [
    ...
    'Aukro protected customer/admin lifecycle API proof and admin visible DOM lifecycle proof are proven; customer visible DOM rows remain gated by a real or bounded customer-bound Aukro order',
