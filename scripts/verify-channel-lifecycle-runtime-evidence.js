...
const CHANNELS = {
  ...
  bazos: {
    ...
    remainingGates: [
      'Bazos paid replay source is deployed and returns HTTP 200, but live proof remains blocked until a real eligible paid multi-product Bazos order or approved bounded fixture exists',
