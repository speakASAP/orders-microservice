...
const CHANNELS = {
  ...
  heureka: {
    ...
    artifactChecks: [
      ...
      {
        root: 'orders',
        file: 'reports/validation/orders-browser-render-proof/heureka-rendered-proof-preflight-blocked.json',
        type: 'json',
        assertions: [
          ['schemaVersion', 'orders.browser_render_proof_preflight_blocker.v1'],
          ['channel', 'heureka'],
          ['status', 'synthetic_rendered_proof_preflight_blocked'],
          ['preflight.mutatingExecutionAttempted', false],
          ['preflight.healthStatus', 200],
          ['preflight.warehouseStatus', 200],
          ['preflight.reservableRouteCount', 1],
          ['preflight.catalogStatus', 401],
          ['authBoundaryProbe.httpStatus', 401],
          ['authBoundaryProbe.tokenPrinted', false],
  ...
  allegro: {
    ...
    remainingGates: [
      'real forwarded Allegro order already subject-bound through buyerAuthSubject and visible to a real Auth bearer',
