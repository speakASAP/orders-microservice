...
const remainingGates = [
  'Warehouse deploy/migration approval for fulfillment_provider_shipment_correlations',
  'Allegro deploy approval before runtime pod receives ALLEGRO_SHIPMENT_DEAD_LETTER_DIR/PVC',
  'owner approval to enable ALLEGRO_WAREHOUSE_SHIPMENT_CORRELATION_ENABLED=true',
  'owner-approved live runtime smoke with safe order selection and real token source',
  'owner approval before runtime fulfillment status mutation or production fulfillment-row mutation',
];
