...
assert.equal(runtimeGateReport.runtimeEvidence.warehouse.providerStatusReadback.observations, 3, 'Warehouse provider observation readback mismatch');
...
assert.equal(runtimeGateReport.runtimeEvidence.warehouse.providerStatusReadback.latestNormalizedWarehouseStatus, 'delivered', 'Warehouse normalized status mismatch');
...
assert.equal(runtimeGateReport.runtimeEvidence.warehouse.fulfillmentMutation.fulfillmentStatus, 'delivered', 'Warehouse fulfillment status readback mismatch');
assert.equal(runtimeGateReport.runtimeEvidence.orders.warehouseCallbackReadback.centralStatus, 'received', 'Orders central status readback mismatch');
