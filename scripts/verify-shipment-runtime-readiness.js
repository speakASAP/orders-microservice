...
assert.equal(runtimeGateReport.runtimeEvidence.warehouse.providerStatusReadback.observations, 4, 'Warehouse provider observation readback mismatch');
...
assert.equal(runtimeGateReport.runtimeEvidence.warehouse.providerStatusReadback.latestNormalizedWarehouseStatus, 'returned', 'Warehouse normalized status mismatch');
...
assert.equal(runtimeGateReport.runtimeEvidence.warehouse.fulfillmentMutation.fulfillmentStatus, 'returned', 'Warehouse fulfillment status readback mismatch');
assert.equal(runtimeGateReport.runtimeEvidence.orders.warehouseCallbackReadback.centralStatus, 'returned', 'Orders central status readback mismatch');
