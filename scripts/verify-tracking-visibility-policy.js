...
const result = {
  ...
  remainingGates: [
    ...
    'Allegro/Warehouse source hardening is landed and the Auth-issued internal:allegro-service:service token is projected as effective WAREHOUSE_INTERNAL_SERVICE_TOKEN with WAREHOUSE_SERVICE_TOKEN retained only as a source compatibility fallback; remaining gates are optional real provider live-read and future audited full-tracking reveal',
  ],
};
