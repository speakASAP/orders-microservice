...
- Integration owner should decide whether to open/merge the Orders evidence branch and separately reconcile Marketing/Catalog run-ledger history for this window.
