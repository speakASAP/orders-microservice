...
| Payments/provider authority | Named human Payments/provider rollback owner with bank/refund authority and evidence review responsibility | `[MISSING: named human Payments/provider rollback execution owner with bank/refund authority for runtime]` |
| Bank/refund executor | Named executor, exact destination/source account proof, amount, reference, deadline, and redacted completion evidence | `[MISSING: named bank/refund executor, exact destination/source account proof, amount, reference, deadline, and redacted completion evidence for the future linked payment]` |
...
| --- | --- | --- | --- | --- | --- |
| Payments provider/refund authority | blocked | named human with bank/refund authority | Payments provider/refund packet and redacted proof | `[MISSING: named human Payments/provider rollback execution owner with bank/refund authority for runtime]` | 1 |
