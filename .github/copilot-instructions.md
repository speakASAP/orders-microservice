# Copilot Instructions — `orders-microservice`
...
- **Authoritative path**: `/home/ssf/Documents/Github/orders-microservice` on the `alfares` server.
- **Origin**: `git@github.com:speakASAP/orders-microservice.git`, branch `main`.
